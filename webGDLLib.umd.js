(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("react-dom")) : typeof define === "function" && define.amd ? define(["exports", "react", "react-dom"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.MyLibrary = {}, global.React, global.ReactDOM));
  ...
  const ParametersForm = ({
    ...
    if (!current) return;
    const [paramsJsonData, setParamsJsonData] = React$1.useState(null);
    const [paramName, setParamName] = React$1.useState();
  ...
  */
  ...
  function isReactElement(node2) {
    return /* @__PURE__ */ React$1.isValidElement(node2) && !reactIsExports.isFragment(node2);
  }
  ...
  var useInternalLayoutEffect = process$1.env.NODE_ENV !== "test" && canUseDom() ? React__namespace.useLayoutEffect : React__namespace.useEffect;
  ...
  function useCacheToken(theme, tokens) {
    ...
    var _useContext = React$1.useContext(StyleContext$1), instanceId = _useContext.cache.instanceId, container = _useContext.container;
          ...
          if (_typeof(value) === "object" && value && (key !== "animationName" || !value._keyframe) && !isCompoundCSSProperty(value)) {
            ...
            let appendStyle = function(cssKey, cssValue) {
              if (process$1.env.NODE_ENV !== "production" && (_typeof(value) !== "object" || !(value !== null && value !== void 0 && value[SKIP_CHECK]))) {
                [linter$1, linter].concat(_toConsumableArray(linters)).forEach(function(linter2) {
                  return linter2(cssKey, cssValue, {
                    path,
                    hashId,
                    parentSelectors
                  });
  ...
  function useStyleRegister(info, styleFn) {
    ...
    var _React$useContext = React__namespace.useContext(StyleContext$1), autoClear = _React$useContext.autoClear, mock = _React$useContext.mock, defaultCache = _React$useContext.defaultCache, hashPriority = _React$useContext.hashPriority, container = _React$useContext.container, ssrInline = _React$useContext.ssrInline, transformers = _React$useContext.transformers, linters = _React$useContext.linters, cache = _React$useContext.cache, enableLayer = _React$useContext.layer;
    ...
    return function(node2) {
      ...
      if (!ssrInline || isMergedClientSide || !defaultCache) {
        ...
        styleNode = /* @__PURE__ */ React__namespace.createElement("style", _extends({}, _defineProperty$1(_defineProperty$1({}, ATTR_TOKEN, cachedTokenKey), ATTR_MARK, cachedStyleId), {
  ...
  const ValidateMessagesContext = /* @__PURE__ */ React$1.createContext(void 0);
  var locale$3 = {
    // Options
    items_per_page: "/ page",
    jump_to: "Go to",
...
'Noto Color Emoji'`,
  ...
  function useConfig() {
    const componentDisabled = React$1.useContext(DisabledContext);
    const componentSize = React$1.useContext(SizeContext);
    return {
      componentDisabled,
      componentSize
    };
  ...
  const genCSSVarRegister = (component, getDefaultToken, options) => {
    ...
    const useCSSVar = (rootCls) => {
      ...
      return [(node2) => injectStyle && cssVar ? /* @__PURE__ */ React$1.createElement(React$1.Fragment, null, /* @__PURE__ */ React$1.createElement(CSSVarRegister, {
        rootCls,
        cssVar,
        component
  ...
  var useInsertStyles = function useInsertStyles2(eleRef) {
    var _useContext = React$1.useContext(IconContext), csp = _useContext.csp, prefixCls = _useContext.prefixCls;
  ...
  var RefIcon$7 = /* @__PURE__ */ React__namespace.forwardRef(LoadingOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  const InnerLoadingIcon = /* @__PURE__ */ React$1.forwardRef((props, ref) => {
    ...
    return /* @__PURE__ */ React$1.createElement(IconWrapper, {
      ...
      style: style2,
      ref
    }, /* @__PURE__ */ React$1.createElement(RefIcon$7, {
  ...
  function useFrameWheel(inVirtual, isScrollAtTop, isScrollAtBottom, isScrollAtLeft, isScrollAtRight, horizontalScroll, onWheelDelta) {
    ...
    var wheelDirectionRef = React$1.useRef(null);
    var wheelDirectionCleanRef = React$1.useRef(null);
  ...
  function useMobileTouchMove(inVirtual, listRef, callback) {
    ...
    var touchXRef = React$1.useRef(0);
  ...
  function RawList(props, ref) {
    ...
    var containerHeight = React__namespace.useMemo(function() {
    ...
    var _useState = React$1.useState(0), _useState2 = _slicedToArray(_useState, 2), offsetTop = _useState2[0], setOffsetTop = _useState2[1];
    var _useState3 = React$1.useState(0), _useState4 = _slicedToArray(_useState3, 2), offsetLeft = _useState4[0], setOffsetLeft = _useState4[1];
    var _useState5 = React$1.useState(false), _useState6 = _slicedToArray(_useState5, 2), scrollMoving = _useState6[0], setScrollMoving = _useState6[1];
    ...
    var verticalScrollBarRef = React$1.useRef();
    var horizontalScrollBarRef = React$1.useRef();
    ...
    var lastVirtualScrollInfoRef = React$1.useRef(getVirtualScrollInfo());
  ...
  var InternalTreeNode = /* @__PURE__ */ function(_React$Component) {
    ...
    function InternalTreeNode2() {
      ...
      _defineProperty$1(_assertThisInitialized(_this), "renderDragHandler", function() {
        ...
        return draggable !== null && draggable !== void 0 && draggable.icon ? /* @__PURE__ */ React__namespace.createElement("span", {
      ...
      value: (
        ...
        function render2() {
          ...
          return /* @__PURE__ */ React__namespace.createElement("div", _extends({
            ...
            onMouseMove
          }, ariaSelected, dataOrAriaAttributeProps), /* @__PURE__ */ React__namespace.createElement(Indent$1, {
            prefixCls,
            level,
            isStart,
            isEnd
  ...
  var ContextTreeNode = function ContextTreeNode2(props) {
    return /* @__PURE__ */ React__namespace.createElement(TreeContext.Consumer, null, function(context) {
      return /* @__PURE__ */ React__namespace.createElement(InternalTreeNode, _extends({}, props, {
        context
      }));
    });
  };
  ...
  function useUnmount(triggerStart, triggerEnd) {
    var _React$useState = React__namespace.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), firstMount = _React$useState2[0], setFirstMount = _React$useState2[1];
    useLayoutEffect(function() {
      if (firstMount) {
        triggerStart();
        return function() {
  ...
  var MotionTreeNode = function MotionTreeNode2(_ref, ref) {
    ...
    var _React$useState = React__namespace.useState(true), _React$useState2 = _slicedToArray(_React$useState, 2), visible = _React$useState2[0], setVisible = _React$useState2[1];
    ...
    if (motionNodes) {
      return /* @__PURE__ */ React__namespace.createElement(CSSMotion, _extends({
        ...
        return /* @__PURE__ */ React__namespace.createElement("div", {
          ...
          return /* @__PURE__ */ React__namespace.createElement(ContextTreeNode, _extends({}, restProps, treeNodeProps, {
            title,
            active,
            data: treeNode.data,
            key,
    ...
    return /* @__PURE__ */ React__namespace.createElement(ContextTreeNode, _extends({
      domRef: ref,
      className,
      style: style2
    }, props, {
  ...
  var NodeList = /* @__PURE__ */ React__namespace.forwardRef(function(props, ref) {
    ...
    var _React$useState = React__namespace.useState(expandedKeys), _React$useState2 = _slicedToArray(_React$useState, 2), prevExpandedKeys = _React$useState2[0], setPrevExpandedKeys = _React$useState2[1];
    var _React$useState3 = React__namespace.useState(data), _React$useState4 = _slicedToArray(_React$useState3, 2), prevData = _React$useState4[0], setPrevData = _React$useState4[1];
    var _React$useState5 = React__namespace.useState(data), _React$useState6 = _slicedToArray(_React$useState5, 2), transitionData = _React$useState6[0], setTransitionData = _React$useState6[1];
    var _React$useState7 = React__namespace.useState([]), _React$useState8 = _slicedToArray(_React$useState7, 2), transitionRange = _React$useState8[0], setTransitionRange = _React$useState8[1];
    var _React$useState9 = React__namespace.useState(null), _React$useState10 = _slicedToArray(_React$useState9, 2), motionType = _React$useState10[0], setMotionType = _React$useState10[1];
    ...
    return /* @__PURE__ */ React__namespace.createElement(React__namespace.Fragment, null, focused && activeItem && /* @__PURE__ */ React__namespace.createElement("span", {
      style: HIDDEN_STYLE,
      "aria-live": "assertive"
    }, getAccessibilityPath(activeItem)), /* @__PURE__ */ React__namespace.createElement("div", null, /* @__PURE__ */ React__namespace.createElement("input", {
      style: HIDDEN_STYLE,
    ...
    }))), /* @__PURE__ */ React__namespace.createElement(List, _extends({}, domProps, {
      data: mergedData,
      itemKey,
      height,
      fullHeight: false,
      ...
      return /* @__PURE__ */ React__namespace.createElement(RefMotionTreeNode, _extends({}, restProps, treeNodeProps, {
        title,
    ...
    _createClass(Tree2, [{
      ...
      value: function render2() {
        ...
        return /* @__PURE__ */ React__namespace.createElement(TreeContext.Provider, {
          ...
          style: rootStyle
        }, /* @__PURE__ */ React__namespace.createElement(NodeList, _extends({
          ref: this.listRef,
          prefixCls,
          style: style2,
          data: flattenNodes,
  ...
  var RefIcon$6 = /* @__PURE__ */ React__namespace.forwardRef(FileOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  var RefIcon$5 = /* @__PURE__ */ React__namespace.forwardRef(FolderOpenOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  var RefIcon$4 = /* @__PURE__ */ React__namespace.forwardRef(FolderOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  var RefIcon$3 = /* @__PURE__ */ React__namespace.forwardRef(HolderOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  var RefIcon$2 = /* @__PURE__ */ React__namespace.forwardRef(CaretDownFilled);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  var RefIcon$1 = /* @__PURE__ */ React__namespace.forwardRef(MinusSquareOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  var RefIcon = /* @__PURE__ */ React__namespace.forwardRef(PlusSquareOutlined);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  const SwitcherIconCom = (props) => {
    ...
    if (isLeaf) {
      ...
      return showLeafIcon ? /* @__PURE__ */ React__namespace.createElement(RefIcon$6, {
    ...
    if (showLine) {
      return expanded ? /* @__PURE__ */ React__namespace.createElement(RefIcon$1, {
        className: `${prefixCls}-switcher-line-icon`
      }) : /* @__PURE__ */ React__namespace.createElement(RefIcon, {
        className: `${prefixCls}-switcher-line-icon`
      });
    }
    return /* @__PURE__ */ React__namespace.createElement(RefIcon$2, {
      className: switcherCls
    });
  };
  const Tree$1 = /* @__PURE__ */ React$1.forwardRef((props, ref) => {
    ...
    const draggableConfig = React$1.useMemo(() => {
      ...
      if (mergedDraggable.icon !== false) {
        mergedDraggable.icon = mergedDraggable.icon || /* @__PURE__ */ React$1.createElement(RefIcon$3, null);
      }
      return mergedDraggable;
    }, [draggable]);
    const renderSwitcherIcon = (nodeProps) => /* @__PURE__ */ React$1.createElement(SwitcherIconCom, {
      prefixCls,
      switcherIcon,
  ...
  function getIcon(props) {
    ...
    if (isLeaf) {
      return /* @__PURE__ */ React__namespace.createElement(RefIcon$6, null);
    }
    return expanded ? /* @__PURE__ */ React__namespace.createElement(RefIcon$5, null) : /* @__PURE__ */ React__namespace.createElement(RefIcon$4, null);
  }
  ...
  const DirectoryTree$1 = (_a, ref) => {
    ...
    const lastSelectedKey = React__namespace.useRef();
    const cachedSelectedKeys = React__namespace.useRef();
    ...
    return /* @__PURE__ */ React__namespace.createElement(Tree$1, Object.assign({
      icon: getIcon,
      ref,
      blockNode: true
    }, otherProps, {
  ...
  const ForwardDirectoryTree = /* @__PURE__ */ React__namespace.forwardRef(DirectoryTree$1);
  if (process$1.env.NODE_ENV !== "production") {
  ...
  */
  ...
  (function(exports3) {
    ...
    Object.defineProperty(exports3, "DraggableCore", {
      enumerable: true,
      get: function() {
  ...
  const PropertiesDialog = (props) => {
    ...
    const dialogRef = React$1.useRef();
    const handleOk = () => {
      if (onOk) {
        onOk();
        return;
  ...
  const WebGDL = ({ consumerSetMeshes }) => {
    ...
    const [currentGSM, setCurrentGSM] = React$1.useState();
    const [jsonData, setJsonData] = React$1.useState();
    const [textureLocation, setTextureLocation] = React$1.useState("");
    ...
    const [showParameterDialog, setShowParameterDialog] = React$1.useState(false);
